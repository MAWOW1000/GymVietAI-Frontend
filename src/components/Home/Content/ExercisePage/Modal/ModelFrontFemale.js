    ...
    return (
        <div className="model-front">
            <svg viewBox="0 0 700 1200" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g className="body-map__muscle " onClick={handleClick} id="quads" >
                ...
                <g className="body-map__muscle " onClick={handleClick} id="obliques" >
                ...
                <g className="body-map__muscle " onClick={handleClick} id="abdominals" >
                ...
                <g className="body-map__muscle " onClick={handleClick} id="biceps" >
                ...
                <g className="body-map__muscle " onClick={handleClick} id="chest" data-muscle="Chest">
                ...
                <g className="body-map__muscle " onClick={handleClick} id="front-shoulders" data-muscle="Front Shoulders">
