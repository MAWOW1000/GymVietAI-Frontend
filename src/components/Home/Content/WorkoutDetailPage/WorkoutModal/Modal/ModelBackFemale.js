...
function ModelBackFemale({ setSelectedMuscle, selectedMuscle, setPage }) {
    useEffect(() => {
    ...
    return (
        <div className="model-back">
            <svg viewBox="0 0 700 1200" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g className="body-map__muscle " onClick={handleClick} id="lowerback" data-muscle="Lower back">
                ...
                <g className="body-map__muscle " onClick={handleClick} id="traps">
                ...
                <g className="body-map__muscle " onClick={handleClick} id="forearms">
                ...
                <g className="body-map__muscle " onClick={handleClick} id="triceps">
                ...
                <g className="body-map__muscle " onClick={handleClick} id="calves">
                ...
                <g className="body-map__muscle " onClick={handleClick} id="hamstrings">
                ...
                <g className="body-map__muscle " onClick={handleClick} id="glutes">
                ...
                <g className="body-map__muscle " onClick={handleClick} id="lats">
                ...
                <g className="body-map__muscle " onClick={handleClick} id="rear-shoulders" data-muscle="Rear Shoulders">
                ...
                <g className="body-map__muscle " onClick={handleClick} id="traps-middle" data-muscle="Traps Middle">
...
export default ModelBackFemale;