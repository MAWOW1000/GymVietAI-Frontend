...
function ModelBackFemale({ groupMuscle }) {
    useEffect(() => {
        ...
        muscleElements.forEach(element => {
            ...
            if (groupMuscle.toLowerCase() === muscleId) {
    ...
    return (
        <div className="model-back">
            <svg viewBox="0 0 700 1200" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <g className="body-map__muscle " id="lowerback" data-muscle="Lower back">
                ...
                <g className="body-map__muscle " id="triceps">
                ...
                <g className="body-map__muscle " id="hamstrings">
                ...
                <g className="body-map__muscle " id="glutes">
                ...
                <g className="body-map__muscle " id="lats">
                ...
                <g className="body-map__muscle " id="rear-shoulders" data-muscle="Rear Shoulders">
                ...
                <g className="body-map__muscle " id="traps-middle" data-muscle="Traps Middle">
